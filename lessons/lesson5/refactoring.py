...
# hashtable_update and hashtable_lookup, we should think if there is a better
# way to write this that would avoid the duplication. We should be able to
# rewrite these procedures to be shorter by defining a new procedure and
# rewriting both hashtable_update and hashtable_lookup to use that procedure.
