...
def involved(courses, person):
    ...
    for hexamester in courses:
        for clase in courses[hexamester]: # 'clase' is spanish name for 'class'
            for entry in courses[hexamester][clase]:
                if person == courses[hexamester][clase][entry]:
                    classes.append(clase)
        if classes != []:
            courses_involved[hexamester] = classes
            classes = []
    return courses_involved

"""

# The Solution of Udacity #
...
def involved(courses, person):
    ...
    for hexamester in courses:
        for clase in courses[hexamester]: # 'clase' is spanish name for 'class'
            for entry in courses[hexamester][clase]:
                if person == courses[hexamester][clase][entry]:
                    if hexamester in courses_involved:
                        courses_involved[hexamester].append(clase)
                    else:
                        courses_involved[hexamester] = [clase]
    return courses_involved
